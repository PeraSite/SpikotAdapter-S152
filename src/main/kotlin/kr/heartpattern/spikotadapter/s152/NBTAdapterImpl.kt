...
class NBTAdapterImpl : AbstractModule(), NBTAdapter {
    ...
    override fun createNBTLongArray(value: LongArray): WrapperNBTLongArray = throw UnsupportedOperationException()
    ...
    override fun wrapNBTLongArray(tag: Any): WrapperNBTLongArray = throw UnsupportedOperationException()
